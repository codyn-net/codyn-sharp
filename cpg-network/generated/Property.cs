...
#region Autogenerated code
	public class Property : GLib.InitiallyUnowned, Cpg.Usable {
		...
		[DllImport("cpg-network-2.0")]
		static extern bool cpg_property_get_modified(IntPtr raw);

		[DllImport("cpg-network-2.0")]
		static extern void cpg_property_set_modified(IntPtr raw, bool modified);

		[GLib.Property ("modified")]
		public bool Modified {
			get  {
				bool raw_ret = cpg_property_get_modified(Handle);
				bool ret = raw_ret;
				return ret;
			}
			set  {
				cpg_property_set_modified(Handle, value);
			}
		}
