...
#region Autogenerated code
	...
	internal class MiniObjectFinalizeFunctionInvoker {
		...
		internal Cpg.MiniObjectFinalizeFunction Handler {
			get {
				return new Cpg.MiniObjectFinalizeFunction(InvokeNative);
			}
		}

		void InvokeNative (Cpg.MiniObject obj)
		{
	...
	internal class MiniObjectFinalizeFunctionWrapper {
		...
		{
			try {
				managed (Cpg.MiniObject.GetObject(obj));
				if (release_on_call)
					gch.Free ();
			} catch (Exception e) {
		...
		Cpg.MiniObjectFinalizeFunction managed;

		public MiniObjectFinalizeFunctionWrapper (Cpg.MiniObjectFinalizeFunction managed)
		{
		...
		public static Cpg.MiniObjectFinalizeFunction GetManagedDelegate (MiniObjectFinalizeFunctionNative native)
		{
			if (native == null)
				return null;
