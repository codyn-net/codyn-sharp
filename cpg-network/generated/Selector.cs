...
#region Autogenerated code
	public class Selector : GLib.Object, Cpg.Statement {
		...
		static extern IntPtr cpg_selector_new(IntPtr root);

		public Selector (Cpg.Object root) : base (IntPtr.Zero)
		{
			...
			Raw = cpg_selector_new(root == null ? IntPtr.Zero : root.Handle);
		}

		[GLib.Property ("root")]
		public Cpg.Object Root {
			get {
		...
		[DllImport("cpg-network-2.0")]
		static extern IntPtr cpg_selector_copy_with(IntPtr raw);

		public Cpg.Selector CopyWith() {
			IntPtr raw_ret = cpg_selector_copy_with(Handle);
		...
		[DllImport("cpg-network-2.0")]
		static extern void cpg_selector_set_self(IntPtr raw, IntPtr selection);

		public Cpg.Selection Self { 
			set {
				cpg_selector_set_self(Handle, value == null ? IntPtr.Zero : value.Handle);
			}
		}

		[DllImport("cpg-network-2.0")]
		static extern void cpg_selector_set_implicit_children(IntPtr raw, bool isimplicit);

		public bool ImplicitChildren { 
			set {
				cpg_selector_set_implicit_children(Handle, value);
			}
		}
		...
		[DllImport("cpg-network-2.0")]
		static extern void cpg_selector_set_from_set(IntPtr raw, IntPtr selections);

		public GLib.SList FromSet { 
			set {
				cpg_selector_set_from_set(Handle, value == null ? IntPtr.Zero : value.Handle);
			}
		}
		...
		[DllImport("cpg-network-2.0")]
		static extern unsafe IntPtr cpg_selector_parse(IntPtr root, IntPtr ptr, out IntPtr error);

		public static unsafe Cpg.Selector Parse(Cpg.Object root, string ptr) {
			IntPtr native_ptr = GLib.Marshaller.StringToPtrGStrdup (ptr);
			IntPtr error = IntPtr.Zero;
			IntPtr raw_ret = cpg_selector_parse(root == null ? IntPtr.Zero : root.Handle, native_ptr, out error);
			Cpg.Selector ret = GLib.Object.GetObject(raw_ret) as Cpg.Selector;
