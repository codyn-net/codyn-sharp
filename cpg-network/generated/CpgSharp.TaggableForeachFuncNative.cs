...
#region Autogenerated code
	...
	internal class TaggableForeachFuncInvoker {
		...
		internal Cpg.TaggableForeachFunc Handler {
			get {
				return new Cpg.TaggableForeachFunc(InvokeNative);
			}
		}

		void InvokeNative (Cpg.Taggable taggable, string key, string value)
		{
	...
	internal class TaggableForeachFuncWrapper {
		...
		{
			try {
				managed (Cpg.TaggableAdapter.GetObject (taggable, false), GLib.Marshaller.Utf8PtrToString (key), GLib.Marshaller.Utf8PtrToString (value));
				if (release_on_call)
					gch.Free ();
			} catch (Exception e) {
		...
		Cpg.TaggableForeachFunc managed;

		public TaggableForeachFuncWrapper (Cpg.TaggableForeachFunc managed)
		{
		...
		public static Cpg.TaggableForeachFunc GetManagedDelegate (TaggableForeachFuncNative native)
		{
			if (native == null)
				return null;
